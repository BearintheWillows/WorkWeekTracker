...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WWTApi.Data.WorkModels.DailyRoute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WWTApi.Data.WorkModels.Run", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WWTApi.Data.WorkModels.Shop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WWTApi.Data.WorkModels.DailyRoute", b =>
                {
                    b.HasOne("WWTApi.Data.WorkModels.Run", "Run")
                        .WithMany("DailyRoutePlans")
                        .HasForeignKey("RunId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WWTApi.Data.WorkModels.Shop", "Shop")
                        .WithMany("DailyRoutePlans")
